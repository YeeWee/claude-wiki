...
```typescript
// src/state/AppStateStore.ts:173-184
mcp: {
...
```typescript
// src/state/AppStateStore.ts:185-216
plugins: {
...
```typescript
// src/state/AppStateStore.ts:58-77
